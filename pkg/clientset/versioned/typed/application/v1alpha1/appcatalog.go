...
type AppCatalogInterface interface {
	...
	UpdateStatus(ctx context.Context, appCatalog *v1alpha1.AppCatalog, opts v1.UpdateOptions) (*v1alpha1.AppCatalog, error)
...
func (c *appCatalogs) UpdateStatus(ctx context.Context, appCatalog *v1alpha1.AppCatalog, opts v1.UpdateOptions) (result *v1alpha1.AppCatalog, err error) {
	result = &v1alpha1.AppCatalog{}
	err = c.client.Put().
		Resource("appcatalogs").
		Name(appCatalog.Name).
