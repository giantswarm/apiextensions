...
type AWSMachineDeploymentInterface interface {
	Create(ctx context.Context, aWSMachineDeployment *v1alpha3.AWSMachineDeployment, opts v1.CreateOptions) (*v1alpha3.AWSMachineDeployment, error)
	Update(ctx context.Context, aWSMachineDeployment *v1alpha3.AWSMachineDeployment, opts v1.UpdateOptions) (*v1alpha3.AWSMachineDeployment, error)
	UpdateStatus(ctx context.Context, aWSMachineDeployment *v1alpha3.AWSMachineDeployment, opts v1.UpdateOptions) (*v1alpha3.AWSMachineDeployment, error)
	Delete(ctx context.Context, name string, opts v1.DeleteOptions) error
	DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error
	Get(ctx context.Context, name string, opts v1.GetOptions) (*v1alpha3.AWSMachineDeployment, error)
	List(ctx context.Context, opts v1.ListOptions) (*v1alpha3.AWSMachineDeploymentList, error)
	Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error)
	Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha3.AWSMachineDeployment, err error)
...
func newAWSMachineDeployments(c *InfrastructureV1alpha3Client, namespace string) *aWSMachineDeployments {
...
func (c *aWSMachineDeployments) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha3.AWSMachineDeployment, err error) {
	result = &v1alpha3.AWSMachineDeployment{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *aWSMachineDeployments) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha3.AWSMachineDeploymentList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha3.AWSMachineDeploymentList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("awsmachinedeployments").
...
func (c *aWSMachineDeployments) Create(ctx context.Context, aWSMachineDeployment *v1alpha3.AWSMachineDeployment, opts v1.CreateOptions) (result *v1alpha3.AWSMachineDeployment, err error) {
	result = &v1alpha3.AWSMachineDeployment{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("awsmachinedeployments").
...
func (c *aWSMachineDeployments) Update(ctx context.Context, aWSMachineDeployment *v1alpha3.AWSMachineDeployment, opts v1.UpdateOptions) (result *v1alpha3.AWSMachineDeployment, err error) {
	result = &v1alpha3.AWSMachineDeployment{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("awsmachinedeployments").
...
func (c *aWSMachineDeployments) UpdateStatus(ctx context.Context, aWSMachineDeployment *v1alpha3.AWSMachineDeployment, opts v1.UpdateOptions) (result *v1alpha3.AWSMachineDeployment, err error) {
	result = &v1alpha3.AWSMachineDeployment{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("awsmachinedeployments").
...
func (c *aWSMachineDeployments) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha3.AWSMachineDeployment, err error) {
	result = &v1alpha3.AWSMachineDeployment{}
