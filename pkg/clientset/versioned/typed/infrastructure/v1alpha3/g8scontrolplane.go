...
type G8sControlPlaneInterface interface {
	Create(ctx context.Context, g8sControlPlane *v1alpha3.G8sControlPlane, opts v1.CreateOptions) (*v1alpha3.G8sControlPlane, error)
	Update(ctx context.Context, g8sControlPlane *v1alpha3.G8sControlPlane, opts v1.UpdateOptions) (*v1alpha3.G8sControlPlane, error)
	UpdateStatus(ctx context.Context, g8sControlPlane *v1alpha3.G8sControlPlane, opts v1.UpdateOptions) (*v1alpha3.G8sControlPlane, error)
	Delete(ctx context.Context, name string, opts v1.DeleteOptions) error
	DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error
	Get(ctx context.Context, name string, opts v1.GetOptions) (*v1alpha3.G8sControlPlane, error)
	List(ctx context.Context, opts v1.ListOptions) (*v1alpha3.G8sControlPlaneList, error)
	Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error)
	Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha3.G8sControlPlane, err error)
...
func newG8sControlPlanes(c *InfrastructureV1alpha3Client, namespace string) *g8sControlPlanes {
...
func (c *g8sControlPlanes) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha3.G8sControlPlane, err error) {
	result = &v1alpha3.G8sControlPlane{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *g8sControlPlanes) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha3.G8sControlPlaneList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha3.G8sControlPlaneList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("g8scontrolplanes").
...
func (c *g8sControlPlanes) Create(ctx context.Context, g8sControlPlane *v1alpha3.G8sControlPlane, opts v1.CreateOptions) (result *v1alpha3.G8sControlPlane, err error) {
	result = &v1alpha3.G8sControlPlane{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("g8scontrolplanes").
...
func (c *g8sControlPlanes) Update(ctx context.Context, g8sControlPlane *v1alpha3.G8sControlPlane, opts v1.UpdateOptions) (result *v1alpha3.G8sControlPlane, err error) {
	result = &v1alpha3.G8sControlPlane{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("g8scontrolplanes").
...
func (c *g8sControlPlanes) UpdateStatus(ctx context.Context, g8sControlPlane *v1alpha3.G8sControlPlane, opts v1.UpdateOptions) (result *v1alpha3.G8sControlPlane, err error) {
	result = &v1alpha3.G8sControlPlane{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("g8scontrolplanes").
...
func (c *g8sControlPlanes) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha3.G8sControlPlane, err error) {
	result = &v1alpha3.G8sControlPlane{}
