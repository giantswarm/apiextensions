...
var silencesKind = schema.GroupVersionKind{Group: "monitoring.giantswarm.io", Version: "v1alpha1", Kind: "Silence"}
...
func (c *FakeSilences) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.Silence, err error) {
	...
	return obj.(*v1alpha1.Silence), err
}
...
func (c *FakeSilences) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.SilenceList, err error) {
	...
	list := &v1alpha1.SilenceList{ListMeta: obj.(*v1alpha1.SilenceList).ListMeta}
	for _, item := range obj.(*v1alpha1.SilenceList).Items {
