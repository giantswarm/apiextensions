...
func (c *FakeFlannelConfigs) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.FlannelConfig, err error) {
	obj, err := c.Fake.
...
func (c *FakeFlannelConfigs) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.FlannelConfigList, err error) {
	obj, err := c.Fake.
...
func (c *FakeFlannelConfigs) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
...
func (c *FakeFlannelConfigs) Create(ctx context.Context, flannelConfig *v1alpha1.FlannelConfig, opts v1.CreateOptions) (result *v1alpha1.FlannelConfig, err error) {
	obj, err := c.Fake.
...
func (c *FakeFlannelConfigs) Update(ctx context.Context, flannelConfig *v1alpha1.FlannelConfig, opts v1.UpdateOptions) (result *v1alpha1.FlannelConfig, err error) {
	obj, err := c.Fake.
...
func (c *FakeFlannelConfigs) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
...
func (c *FakeFlannelConfigs) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	action := testing.NewDeleteCollectionAction(flannelconfigsResource, c.ns, listOpts)
...
func (c *FakeFlannelConfigs) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.FlannelConfig, err error) {
	obj, err := c.Fake.
