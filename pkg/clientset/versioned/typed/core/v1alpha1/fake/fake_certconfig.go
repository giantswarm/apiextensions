...
func (c *FakeCertConfigs) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.CertConfig, err error) {
	obj, err := c.Fake.
...
func (c *FakeCertConfigs) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.CertConfigList, err error) {
	obj, err := c.Fake.
...
func (c *FakeCertConfigs) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
...
func (c *FakeCertConfigs) Create(ctx context.Context, certConfig *v1alpha1.CertConfig, opts v1.CreateOptions) (result *v1alpha1.CertConfig, err error) {
	obj, err := c.Fake.
...
func (c *FakeCertConfigs) Update(ctx context.Context, certConfig *v1alpha1.CertConfig, opts v1.UpdateOptions) (result *v1alpha1.CertConfig, err error) {
	obj, err := c.Fake.
...
func (c *FakeCertConfigs) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
...
func (c *FakeCertConfigs) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	action := testing.NewDeleteCollectionAction(certconfigsResource, c.ns, listOpts)
...
func (c *FakeCertConfigs) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.CertConfig, err error) {
	obj, err := c.Fake.
