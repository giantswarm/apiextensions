...
var appcatalogsResource = schema.GroupVersionResource{Group: "core.giantswarm.io", Version: "v1alpha1", Resource: "appcatalogs"}

var appcatalogsKind = schema.GroupVersionKind{Group: "core.giantswarm.io", Version: "v1alpha1", Kind: "AppCatalog"}
...
func (c *FakeAppCatalogs) UpdateStatus(appCatalog *v1alpha1.AppCatalog) (*v1alpha1.AppCatalog, error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateSubresourceAction(appcatalogsResource, "status", c.ns, appCatalog), &v1alpha1.AppCatalog{})
