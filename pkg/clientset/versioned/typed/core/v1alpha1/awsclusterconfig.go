...
type AWSClusterConfigInterface interface {
	Create(ctx context.Context, aWSClusterConfig *v1alpha1.AWSClusterConfig, opts v1.CreateOptions) (*v1alpha1.AWSClusterConfig, error)
	Update(ctx context.Context, aWSClusterConfig *v1alpha1.AWSClusterConfig, opts v1.UpdateOptions) (*v1alpha1.AWSClusterConfig, error)
	Delete(ctx context.Context, name string, opts v1.DeleteOptions) error
	DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error
	Get(ctx context.Context, name string, opts v1.GetOptions) (*v1alpha1.AWSClusterConfig, error)
	List(ctx context.Context, opts v1.ListOptions) (*v1alpha1.AWSClusterConfigList, error)
	Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error)
	Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.AWSClusterConfig, err error)
...
func (c *aWSClusterConfigs) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.AWSClusterConfig, err error) {
...
func (c *aWSClusterConfigs) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.AWSClusterConfigList, err error) {
...
func (c *aWSClusterConfigs) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *aWSClusterConfigs) Create(ctx context.Context, aWSClusterConfig *v1alpha1.AWSClusterConfig, opts v1.CreateOptions) (result *v1alpha1.AWSClusterConfig, err error) {
	result = &v1alpha1.AWSClusterConfig{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("awsclusterconfigs").
...
func (c *aWSClusterConfigs) Update(ctx context.Context, aWSClusterConfig *v1alpha1.AWSClusterConfig, opts v1.UpdateOptions) (result *v1alpha1.AWSClusterConfig, err error) {
	result = &v1alpha1.AWSClusterConfig{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("awsclusterconfigs").
...
func (c *aWSClusterConfigs) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *aWSClusterConfigs) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *aWSClusterConfigs) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.AWSClusterConfig, err error) {
	result = &v1alpha1.AWSClusterConfig{}
