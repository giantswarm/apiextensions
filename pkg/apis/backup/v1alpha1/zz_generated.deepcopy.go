...
func (in *ETCDBackupStatus) DeepCopyInto(out *ETCDBackupStatus) {
	*out = *in
	if in.Instances != nil {
		...
		*out = make(ETCDInstancesStatus, len(*in))
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in ETCDInstancesStatus) DeepCopyInto(out *ETCDInstancesStatus) {
	{
		in := &in
		*out = make(ETCDInstancesStatus, len(*in))
		for key, val := range *in {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ETCDInstancesStatus.
func (in ETCDInstancesStatus) DeepCopy() ETCDInstancesStatus {
	if in == nil {
		return nil
	}
	out := new(ETCDInstancesStatus)
	in.DeepCopyInto(out)
	return *out
}
