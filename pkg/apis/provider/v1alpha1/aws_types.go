...
// NewAWSConfigCRD returns a CRD defining an AWSConfig.
func NewAWSConfigCRD() *v1.CustomResourceDefinition {
	return crd.LoadV1(provider.Group, provider.KindAWSConfig)
}
