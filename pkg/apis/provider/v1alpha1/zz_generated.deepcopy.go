...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *AzureConfigStatusAzure) DeepCopyInto(out *AzureConfigStatusAzure) {
	*out = *in
	if in.AvailabilityZones != nil {
		in, out := &in.AvailabilityZones, &out.AvailabilityZones
		*out = make([]int, len(*in))
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new AzureConfigStatusAzure.
func (in *AzureConfigStatusAzure) DeepCopy() *AzureConfigStatusAzure {
	if in == nil {
		return nil
	}
	out := new(AzureConfigStatusAzure)
	in.DeepCopyInto(out)
	return out
}
