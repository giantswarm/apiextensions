...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *AWSConfigStatusAWSVPC) DeepCopyInto(out *AWSConfigStatusAWSVPC) {
	*out = *in
	if in.RouteTables != nil {
		in, out := &in.RouteTables, &out.RouteTables
		*out = make([]AWSConfigStatusAWSVPCRouteTable, len(*in))
		copy(*out, *in)
	}
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new AWSConfigStatusAWSVPC.
func (in *AWSConfigStatusAWSVPC) DeepCopy() *AWSConfigStatusAWSVPC {
	if in == nil {
		return nil
	}
	out := new(AWSConfigStatusAWSVPC)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *AWSConfigStatusAWSVPCRouteTable) DeepCopyInto(out *AWSConfigStatusAWSVPCRouteTable) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new AWSConfigStatusAWSVPCRouteTable.
func (in *AWSConfigStatusAWSVPCRouteTable) DeepCopy() *AWSConfigStatusAWSVPCRouteTable {
	if in == nil {
		return nil
	}
	out := new(AWSConfigStatusAWSVPCRouteTable)
	in.DeepCopyInto(out)
	return out
}
