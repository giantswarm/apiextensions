...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *AzureConfigStatusProviderIngressLB) DeepCopyInto(out *AzureConfigStatusProviderIngressLB) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new AzureConfigStatusProviderIngressLB.
func (in *AzureConfigStatusProviderIngressLB) DeepCopy() *AzureConfigStatusProviderIngressLB {
	if in == nil {
		return nil
	}
	out := new(AzureConfigStatusProviderIngressLB)
	in.DeepCopyInto(out)
	return out
}
