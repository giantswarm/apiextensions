...
func (in *AWSConfigSpecAWSVPC) DeepCopyInto(out *AWSConfigSpecAWSVPC) {
	*out = *in
	out.RouteTableNames = in.RouteTableNames
	return
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *AWSConfigSpecAWSVPCRouteTableNames) DeepCopyInto(out *AWSConfigSpecAWSVPCRouteTableNames) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new AWSConfigSpecAWSVPCRouteTableNames.
func (in *AWSConfigSpecAWSVPCRouteTableNames) DeepCopy() *AWSConfigSpecAWSVPCRouteTableNames {
	if in == nil {
		return nil
	}
	out := new(AWSConfigSpecAWSVPCRouteTableNames)
	in.DeepCopyInto(out)
	return out
}
