...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *AWSConfigCredential) DeepCopyInto(out *AWSConfigCredential) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new AWSConfigCredential.
func (in *AWSConfigCredential) DeepCopy() *AWSConfigCredential {
	if in == nil {
		return nil
	}
	out := new(AWSConfigCredential)
	in.DeepCopyInto(out)
	return out
}
