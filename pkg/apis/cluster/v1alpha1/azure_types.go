...
type AzureSpec struct {
	KeyVault       AzureKeyVault       `json:"keyVault"`
	...
	Masters        []AzureNode         `json:"masters"`
	Workers        []AzureNode         `json:"workers"`
	DNSZones       AzureDNSZones       `json:"dnsZones"`
}
...
type AzureNode struct {
	...
	OSImage AzureOSImage `json:"osImage" yaml:"osImage"`
}

type AzureOSImage struct {
