...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *CommonStatusCluster) DeepCopyInto(out *CommonStatusCluster) {
	*out = *in
	if in.Conditions != nil {
		in, out := &in.Conditions, &out.Conditions
		*out = make([]CommonStatusClusterCondition, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
	if in.Versions != nil {
		in, out := &in.Versions, &out.Versions
		*out = make([]CommonStatusClusterVersion, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new CommonStatusCluster.
func (in *CommonStatusCluster) DeepCopy() *CommonStatusCluster {
	if in == nil {
		return nil
	}
	out := new(CommonStatusCluster)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *CommonStatusClusterCondition) DeepCopyInto(out *CommonStatusClusterCondition) {
	*out = *in
	in.LastTransitionTime.DeepCopyInto(&out.LastTransitionTime)
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new CommonStatusClusterCondition.
func (in *CommonStatusClusterCondition) DeepCopy() *CommonStatusClusterCondition {
	if in == nil {
		return nil
	}
	out := new(CommonStatusClusterCondition)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *CommonStatusClusterVersion) DeepCopyInto(out *CommonStatusClusterVersion) {
	*out = *in
	in.LastTransitionTime.DeepCopyInto(&out.LastTransitionTime)
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new CommonStatusClusterVersion.
func (in *CommonStatusClusterVersion) DeepCopy() *CommonStatusClusterVersion {
	if in == nil {
		return nil
	}
	out := new(CommonStatusClusterVersion)
	in.DeepCopyInto(out)
	return out
}
