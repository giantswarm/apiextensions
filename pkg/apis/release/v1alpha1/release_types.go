...
// +kubebuilder:printcolumn:name="Ready",type=bool,JSONPath=`.status.ready`,description="Whether or not the release is ready"
// +kubebuilder:printcolumn:name="InUse",type=bool,JSONPath=`.status.inUse`,description="Whether or not the release is in use"
