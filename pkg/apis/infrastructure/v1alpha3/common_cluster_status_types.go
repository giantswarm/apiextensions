...
// CommonClusterStatusVersion informs which azure-operator version was/responsible for this cluster.
type CommonClusterStatusVersion struct {
	// +kubebuilder:validation:Optional
	// Time the cluster assumed the given version.
	LastTransitionTime metav1.Time `json:"lastTransitionTime"`
	// +kubebuilder:validation:Optional
	// The azure-operator version responsible for handling the cluster.
