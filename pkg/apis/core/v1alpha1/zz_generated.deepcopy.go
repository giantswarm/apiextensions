...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *CertConfigSpecConfig) DeepCopyInto(out *CertConfigSpecConfig) {
	*out = *in
	if in.AltNames != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new CertConfigSpecConfig.
func (in *CertConfigSpecConfig) DeepCopy() *CertConfigSpecConfig {
	if in == nil {
		return nil
	}
	out := new(CertConfigSpecConfig)
	in.DeepCopyInto(out)
	return out
}
