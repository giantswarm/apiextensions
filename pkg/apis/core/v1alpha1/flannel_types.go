...
// NewFlannelConfigCRD returns a CRD defining a FlannelConfig.
func NewFlannelConfigCRD() *v1.CustomResourceDefinition {
	return crd.LoadV1(core.Group, core.KindFlannelConfig)
}
