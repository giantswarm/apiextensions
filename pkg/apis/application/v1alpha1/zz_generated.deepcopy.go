...
func (in *AppCatalogEntrySpec) DeepCopyInto(out *AppCatalogEntrySpec) {
	*out = *in
	if in.Apps != nil {
		...
		*out = make([]AppCatalogEntrySpecVersionList, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *AppCatalogEntrySpecVersionList) DeepCopyInto(out *AppCatalogEntrySpecVersionList) {
	*out = *in
	if in.Versions != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new AppCatalogEntrySpecVersionList.
func (in *AppCatalogEntrySpecVersionList) DeepCopy() *AppCatalogEntrySpecVersionList {
	if in == nil {
		return nil
	}
	out := new(AppCatalogEntrySpecVersionList)
	in.DeepCopyInto(out)
	return out
}
