...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *PodNetworkRange) DeepCopyInto(out *PodNetworkRange) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new PodNetworkRange.
func (in *PodNetworkRange) DeepCopy() *PodNetworkRange {
	if in == nil {
		return nil
	}
	out := new(PodNetworkRange)
	in.DeepCopyInto(out)
	return out
}
